...
#import "QZKeyboardAvoidingTableView.h"

@interface QZKeyboardAvoidingTableView () <UITextFieldDelegate, UITextViewDelegate>
@end

@implementation QZKeyboardAvoidingTableView
